...
Version  : 1.8
Release  : 11
URL      : https://github.com/jpirko/libndp/archive/v1.8/libndp-1.8.tar.gz
Source0  : https://github.com/jpirko/libndp/archive/v1.8/libndp-1.8.tar.gz
...
%prep
%setup -q -n libndp-1.8
cd %{_builddir}/libndp-1.8
pushd ..
cp -a libndp-1.8 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1622130039
...
cp %{_builddir}/libndp-1.8/COPYING %{buildroot}/usr/share/package-licenses/libndp/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd ../build32/
%make_install32
